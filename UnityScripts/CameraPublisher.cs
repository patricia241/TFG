...
public class CameraPublisher : Sensor<sensor_msgs.msg.Image>
{
    public Camera cam_;
    ...
    { 
        ...
        ros2UnityComponent = gameObject.AddComponent<ROS2UnityComponent>();
        ros2Node = ros2UnityComponent.CreateNode("UnityImagePub");
        CreateROSParticipants(ros2UnityComponent, ros2Node, "");
    }
